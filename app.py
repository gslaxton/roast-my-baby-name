...
2. Suggest at least 4 adorable and unique nicknames (bullet list):
   - ...
   - ...
   - ...
3. Suggest at least 3 similar names that are also great, with a short reason each (bullet list):
   - ...
   - ...
   - ...
